...
const USER_CONFIG = {
  ...
  USERS: [
    {
      ...
      id: 'oRcpB5zQFBmQH2n_U5X7p565fIJ0',
      // 你想对他发送的模板消息的模板ID
      useTemplateId: '2P_ZZ9BedfXbkvr593-0Gi1p5jFPCXW4Zt1J79a-1GA',
      // 所在省份
      province: '浙江',
      // 所在城市
      city: '金华',
      ...
      openUrl: 'https://astro.sina.com.cn',
     ...
     //   {
      ...
      //  {
       ...
       // },
        // 注意：此条配置日期为阳历日期，因为`type`中 “生日” 之前没有 * 符号
          {
          type: '生日', name: '老婆', year: '2000', date: '08-02',
        },
      ...
      customizedDateList: [
        // 在一起的日子
        { keyword: 'love_day', date: '2022-02-06' },
        // 结婚纪念日
  ...
  CALLBACK_TEMPLATE_ID: 'eY0z0sOWsaFnum0boVzQ5qj3fX-STbLsY9g1zaikDPI',
  ...
  CALLBACK_USERS: [
    {
      ...
      id: 'oRcpB51dVzSI6jp0z0u33b8JI7P4',
    }
    // 你可以不断按格式往下增加
    // ...
  ],
  ...
  FESTIVALS: [
    // 注意：此条配置日期为阴历日期，因为`type`中 “生日” 之前有 * 符号
    {
      type: '*生日', name: '老婆', year: '2000', date: '09-09', isShowAge: true,
    },
    {
      type: '节日', name: '结婚纪念日', year: '2020', date: '09-03',
    },
